...
//touch
!function(a){function i(a,b,c,d){return Math.abs(a-b)>=Math.abs(c-d)?a-b>0?"Left":"Right":c-d>0?"Up":"Down"}function j(){f=null,b.last&&(b.el.trigger("longTap"),b={})}function k(){f&&clearTimeout(f),f=null}function l(){c&&clearTimeout(c),d&&clearTimeout(d),e&&clearTimeout(e),f&&clearTimeout(f),c=d=e=f=null,b={}}function m(a){return("touch"==a.pointerType||a.pointerType==a.MSPOINTER_TYPE_TOUCH)&&a.isPrimary}function n(a,b){return a.type=="pointer"+b||a.type.toLowerCase()=="mspointer"+b}var c,d,e,f,h,b={},g=750;a(document).ready(function(){var o,p,s,t,q=0,r=0;"MSGesture"in window&&(h=new MSGesture,h.target=document.body),a(document).bind("MSGestureEnd",function(a){var c=a.velocityX>1?"Right":a.velocityX<-1?"Left":a.velocityY>1?"Down":a.velocityY<-1?"Up":null;c&&(b.el.trigger("swipe"),b.el.trigger("swipe"+c))}).on("touchstart MSPointerDown pointerdown",function(d){(!(t=n(d,"down"))||m(d))&&(s=t?d:d.originalEvent.touches[0],d.touches&&1===d.touches.length&&b.x2&&(b.x2=void 0,b.y2=void 0),o=Date.now(),p=o-(b.last||o),b.el=a("tagName"in s.target?s.target:s.target.parentNode),c&&clearTimeout(c),b.x1=s.pageX,b.y1=s.pageY,p>0&&250>=p&&(b.isDoubleTap=!0),b.last=o,f=setTimeout(j,g),h&&t&&h.addPointer(d.pointerId))}).on("touchmove MSPointerMove pointermove",function(a){(!(t=n(a,"move"))||m(a))&&(s=t?a:a.originalEvent.touches[0],k(),b.x2=s.pageX,b.y2=s.pageY,q+=Math.abs(b.x1-b.x2),r+=Math.abs(b.y1-b.y2))}).on("touchend MSPointerUp pointerup",function(f){(!(t=n(f,"up"))||m(f))&&(k(),b.x2&&Math.abs(b.x1-b.x2)>30||b.y2&&Math.abs(b.y1-b.y2)>30?e=setTimeout(function(){b.el.trigger("swipe"),b.el.trigger("swipe"+i(b.x1,b.x2,b.y1,b.y2)),b={}},0):"last"in b&&(30>q&&30>r?d=setTimeout(function(){var d=a.Event("tap");d.cancelTouch=l,b.el.trigger(d),b.isDoubleTap?(b.el&&b.el.trigger("doubleTap"),b={}):c=setTimeout(function(){c=null,b.el&&b.el.trigger("singleTap"),b={}},250)},0):b={}),q=r=0)}).on("touchcancel MSPointerCancel pointercancel",l),a(window).on("scroll",l)}),["swipe","swipeLeft","swipeRight","swipeUp","swipeDown","doubleTap","tap","singleTap","longTap"].forEach(function(b){a.fn[b]=function(a){return this.on(b,a)}})}(jQuery);
...
//playinline
var enableInlineVideo=function(){"use strict";function a(a,b,c,d){function g(c){e=b(g,d),a(c-(f||c)),f=c}var e,f;return{start:function(){e||g(0)},stop:function(){c(e),e=null,f=0}}}function b(b){return a(b,requestAnimationFrame,cancelAnimationFrame)}function c(a,b,c){function d(d){(!c||c(a,b))&&d.stopImmediatePropagation()}return a.addEventListener(b,d),d}function d(a,b,c,d){function e(){return c[b]}function f(a){c[b]=a}d&&f(a[b]),Object.defineProperty(a,b,{get:e,set:f})}function e(a,b,c){c.addEventListener(b,function(){return a.dispatchEvent(new Event(b))})}function f(a,b){Promise.resolve().then(function(){a.dispatchEvent(new Event(b))})}function l(a){var b=new Audio;return e(a,"play",b),e(a,"playing",b),e(a,"pause",b),b.crossOrigin=a.crossOrigin,b.src=a.src||a.currentSrc||"data:",b}function p(a,b,c){(o||0)+200<Date.now()&&(a[i]=!0,o=Date.now()),c||(a.currentTime=b),m[++n%3]=0|100*b}function q(a){return a.driver.currentTime>=a.video.duration}function r(a){var b=this;b.video.readyState>=b.video.HAVE_FUTURE_DATA?(b.hasAudio||(b.driver.currentTime=b.video.currentTime+a*b.video.playbackRate/1e3,b.video.loop&&q(b)&&(b.driver.currentTime=0)),p(b.video,b.driver.currentTime)):b.video.networkState===b.video.NETWORK_IDLE&&0===b.video.buffered.length&&b.video.load(),b.video.ended&&(delete b.video[i],b.video.pause(!0))}function s(){var a=this,b=a[h];return a.webkitDisplayingFullscreen?(a[j](),void 0):("data:"!==b.driver.src&&b.driver.src!==a.src&&(p(a,0,!0),b.driver.src=a.src),a.paused&&(b.paused=!1,0===a.buffered.length&&a.load(),b.driver.play(),b.updater.start(),b.hasAudio||(f(a,"play"),b.video.readyState>=b.video.HAVE_ENOUGH_DATA&&f(a,"playing"))),void 0)}function t(a){var b=this,c=b[h];c.driver.pause(),c.updater.stop(),b.webkitDisplayingFullscreen&&b[k](),(!c.paused||a)&&(c.paused=!0,c.hasAudio||f(b,"pause"),b.ended&&!b.webkitDisplayingFullscreen&&(b[i]=!0,f(b,"ended")))}function u(a,c){var d={};a[h]=d,d.paused=!0,d.hasAudio=c,d.video=a,d.updater=b(r.bind(d)),c?d.driver=l(a):(a.addEventListener("canplay",function(){a.paused||f(a,"playing")}),d.driver={src:a.src||a.currentSrc||"data:",muted:!0,paused:!0,pause:function(){d.driver.paused=!0},play:function(){d.driver.paused=!1,q(d)&&p(a,0)},get ended(){return q(d)}}),a.addEventListener("emptied",function(){var b=!d.driver.src||"data:"===d.driver.src;d.driver.src&&d.driver.src!==a.src&&(p(a,0,!0),d.driver.src=a.src,b||!c&&a.autoplay?d.driver.play():d.updater.stop())},!1),a.addEventListener("webkitbeginfullscreen",function(){a.paused?c&&0===d.driver.buffered.length&&d.driver.load():(a.pause(),a[j]())}),c&&(a.addEventListener("webkitendfullscreen",function(){d.driver.currentTime=a.currentTime}),a.addEventListener("seeking",function(){m.indexOf(0|100*a.currentTime)<0&&(d.driver.currentTime=a.currentTime)}))}function v(a){var b=a[i];return delete a[i],!a.webkitDisplayingFullscreen&&!b}function w(a){var b=a[h];a[j]=a.play,a[k]=a.pause,a.play=s,a.pause=t,d(a,"paused",b.driver),d(a,"muted",b.driver,!0),d(a,"playbackRate",b.driver,!0),d(a,"ended",b.driver),d(a,"loop",b.driver,!0),c(a,"seeking",function(a){return!a.webkitDisplayingFullscreen}),c(a,"seeked",function(a){return!a.webkitDisplayingFullscreen}),c(a,"timeupdate",v),c(a,"ended",v)}function x(a,b){if(void 0===b&&(b={}),!a[h]){if(!b.everywhere){if(!g)return;if(!(b.iPad||b.ipad?/iPhone|iPod|iPad/:/iPhone|iPod/).test(navigator.userAgent))return}a.pause();var c=a.autoplay;a.autoplay=!1,u(a,!a.muted),w(a),a.classList.add("IIV"),a.muted&&c&&(a.play(),a.addEventListener("playing",function d(){a.autoplay=!0,a.removeEventListener("playing",d)})),/iPhone|iPod|iPad/.test(navigator.platform)||console.warn("iphone-inline-video is not guaranteed to work in emulated environments")}}var o,g="object"==typeof document&&"object-fit"in document.head.style&&!matchMedia("(-webkit-video-playable-inline)").matches,h="bfred-it:iphone-inline-video",i="bfred-it:iphone-inline-video:event",j="bfred-it:iphone-inline-video:nativeplay",k="bfred-it:iphone-inline-video:nativepause",m=[],n=0;return x}();
...
*/
(function($) {
	$.fn.playinline = function(suc) {
		var that = $(this);
		$(this).each(function(i,d) {
			window.enableInlineVideo($(d).get(0), {everywhere:false});
//			debugEvents(videos[i]);
			...
			// 'volumechange',
				...
				if(suc!=undefined){
					$(d).get(0).addEventListener(event, function () {
						suc(event);
					});
				}
				if(JH.browserios()&&event=="playing"){
					var ios89 = typeof document === 'object' && 'object-fit' in document.head.style && !matchMedia('(-webkit-video-playable-inline)').matches;
					var ua = navigator.userAgent.match(/os\s+(\d+)/i)[1]-0;
					if(JH.browserwx()){
						if(ios89){
							$(that).show();
							$(".playcue").hide();
	...
	$.fn.tabs = function(options) {
		...
		$(this).each(function(i,d){
			...
			var that = $(this);
			$(this).find(".tabs-menu .item").on("tap",function(){
		...
		if(!JH.post){
			...
			$.ajax({
				...
				success: function(d){
					if(loading){
						$.loading.close(function(){
							$("body").append('<div class="page vv z11 pf" style="left:0;top:0;right:0;bottom:0;overflow:auto;opacity:0;"></div>');
...
(function(){
	$(".cabox").each(function(i,d){
		var offsetTop = $(d).offset().top;
		if(offsetTop<=$(window).height()-$(d).height()*0.15){
	...
	$("body").on("click","a",function(e){
		if($(this).attr("href") == "" || $(this).attr("href") == "#"){
			...
			if(reg.test($(this).attr("href"))){
				$('#page').animate({
					scrollTop: $(that.attr("href")).offset().top+$('#page').scrollTop()-60
				}, 500);
			}else{
	...
	$("body").on("tap",".opentel",function(){
		var arr = $(this).attr("data-tel").split(",");
		arr = JH.ArrayUtilities.randomize(arr);
		window.location.href="tel:"+arr[0];
	});
	$("body").on("tap",".opennew",function(){
		JH.load.page($(this).attr("url"));
	});
	$("body").on("tap",".openlink,.openlink2",function(){
	...
	$("body").on("tap",".openqq",function(){
		var arr = $(this).attr("data-qq").split(",");
		arr = JH.ArrayUtilities.randomize(arr);
		if(/MicroMessenger/i.test(navigator.userAgent)){
			window.open("http://wpa.qq.com/msgrd?v=3&uin="+arr[0]+"&site=qq&menu=yes");
		}else{
			window.open("mqqwpa://im/chat?chat_type=wpa&uin="+arr[0]+"&version=1&src_type=web&web_src=oicqzone.com");
		}
	})
	$("body").on("tap",".openshangqiao",function(){
			$("ins").click();
	})
	$("body").on("tap",".openvideo",function(){
		$(".playvideo").remove();
		$("body").append('\
			<div class="playvideo vm vc pf animated fadeIn">\
				<span class="ico ico-video-close pf z11" style="right:0px;top:10px;" id="video-close"></span>\
				<video width="100%" x-webkit-airplay="true" x5-playsinline webkit-playsinline playsinline src="'+$(this).find("video").attr("src")+'"></video>\
		</div>');
		$.loading();
		$(".playvideo").find("video").playinline(function(e){
			if(e=="playing"){
				$.loading.close();
			}
		});
	...
	$("body").on("tap",".playvideo #video-close",function(){
		$(".playvideo").find("video").get(0).pause();
		$(".playvideo").remove();
		$.loading.close();
	})
	$("body").on("tap","#header-menu",function(){
		if(!$(this).find(".header-menu").hasClass("active")){
			$(this).find(".header-menu").addClass("active");
			$(".header").addClass("show active");
			$("#header-menu-list").css({"z-index":9999,visibility:"visible"});
			$("#header-menu-list").animate({opacity:1},300);
			$.doTimeout(300,function(){
				$("#header-menu-list .menu-item a").each(function(i,d){
					$.doTimeout(50*(i+1),function(){
						$(d).css({scale:1.2,opacity:0}).transition({scale:1,opacity:1}, 600,'easeOutSine');
					});
				})
			})
		}else{
			$(this).find(".header-menu").removeClass("active");
			$.doTimeout(150*($("#header-menu-list .menu-item a").length/2),function(){
				$("#header-menu-list").animate({opacity:0},300,function(){
					$("#header-menu-list").css({"z-index":0,visibility:"hidden"});
			...
			$("#header-menu-list .menu-item a").each(function(i,d){
				$.doTimeout((50*($("#header-menu-list .menu-item a").length-i)-50),function(){
					$(d).transition({scale:1.2,opacity:0}, 600,'easeInSine');
				});
			});
		}
	});
...
$(function(){
	$.doTimeout(2000,function(){
		$(".js-animated-circles").toggleClass("animatedChat");
		return true;
	})
})