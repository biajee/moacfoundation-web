...
class TutorialsController extends BaseController {
    public function index() {
        ...
        $this->prepare();
        $this->assign('caption','Tutorials List');
        $this->display();
    }
    ...
    public function add() {
        ...
        $this->assign('caption', 'Add Tutorials');
        $this->display();
    }
    ...
    public function edit() {
        ...
        $this->prepare();
        $this->assign('data', $data);
        $this->assign('caption', 'Edit Tutorials');
        $this->display();
    }
    public function save() {
        ...
        $data['status'] = 1;
        $model->add($data);
        $this->success('Success',U('Tutorials/index'));
    }
