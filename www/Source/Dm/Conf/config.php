...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__ICO__'    => __ROOT__ . '/assets/dm/icon/css',
        '__IMG__'    => __ROOT__ . '/assets/dm/images',
        '__CSS__'    => __ROOT__ . '/assets/dm/css',
        '__JS__'     => __ROOT__ . '/assets/dm/js',
        '__SRC__'     => __ROOT__ . '/assets/dm/src',
    ),
	/* 错误页面模板 */
