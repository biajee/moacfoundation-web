...
return array(
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__ICO__'    => __ROOT__ . '/assets/wap/icon/css',
        '__IMG__'    => __ROOT__ . '/assets/wap/images',
        '__CSS__'    => __ROOT__ . '/assets/wap/css',
        '__JS__'     => __ROOT__ . '/assets/wap/js',
        '__SRC__'     => __ROOT__ . '/assets/wap/src',
    ),
	/* 错误页面模板 */
